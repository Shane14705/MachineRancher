...
{    
    ...
    public class WatsonWsServer : IDisposable
    {
        ...
        /// <summary>
        /// Initializes the Watson websocket server with one or more listener "uris".  
        /// Be sure to call 'Start()' to start the server.
        /// </summary>
        /// <param name="uris">List of FULLY QUALIFIED addresses to listen on</param>
        public WatsonWsServer(List<string> uris)
        {
